...
public class ProductSearch {
	...
	public String toString() {
		return "ProductSearch [id=" + id + ", title=" + title
				+ ", description=" + description + ", brand=" + brand
				+ ", origin=" + origin + ", certifiedHalal=" + certifiedHalal
				+ ", codeGenerate=" + codeGenerate + ", unitDescription="
				+ unitDescription + ", unitHide=" + unitHide + ", available="
				+ available + ", code=" + code + ", quantity=" + quantity
				+ ", basePrice=" + basePrice + ", categoryId=" + categoryId
				+ ", subCategoryId=" + subCategoryId + ", subSubCategoryId="
				+ subSubCategoryId + ", unitId=" + unitId + ", pictureId="
				+ pictureId + ", companyId=" + companyId + "]";
	}
