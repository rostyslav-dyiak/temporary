...
public class PictureResource {
    ...
    @Timed
    public ResponseEntity<Void> create(@RequestBody Picture picture) throws URISyntaxException {
    ...
    @RequestMapping(value = "/pictures",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Void> update(@RequestBody Picture picture) throws URISyntaxException {
