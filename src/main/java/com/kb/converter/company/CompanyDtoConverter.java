...
public class CompanyDtoConverter extends AbstractConverter<Company, CompanyDto> {
    ...
    @Override
    public CompanyDto convert(final Company company, final CompanyDto companyDto) {
    ...
    public CompanyDto convertCompanyToSupplierDto(final Company company){
    ...
    public CompanyDto convertCompanyToEateryDto(final Company company){
