...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .put("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "brand":"SAMPLE_TEXT", "origin":"SAMPLE_TEXT", "certifiedHalal":null, "unitDescription":"SAMPLE_TEXT", "unitHide":null, "available":null, "code":"SAMPLE_TEXT", "codeGenerate":null}""")).asJSON
            .check(status.is(201))
