...
/**
 * Performance test for the EateryDetails entity.
 */
class EateryDetailsGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the EateryDetails entity")
        ...
        .repeat(2) {
            ...
            .check(status.is(201))
            .check(headerRegex("Location", "(.*)").saveAs("new_eateryDetails_url")))
            .pause(10)
            .repeat(5) {
                exec(http("Get created eateryDetails")
                .get("${new_eateryDetails_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created eateryDetails")
            .delete("${new_eateryDetails_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
